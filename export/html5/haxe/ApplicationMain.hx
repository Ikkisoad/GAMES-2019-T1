...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("Strike Tanker STT", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("Strike Tanker STT", null, 640, 480);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "Strike Tanker STT";
		app.meta["name"] = "Strike Tanker STT";
