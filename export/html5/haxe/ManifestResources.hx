...
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_data_room_3_oel extends null { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_data_room_4_oel extends null { }
...
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_images_health_psd extends null { }
...
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_images_tiles_psd extends null { }
...
@:keep @:file("assets/data/room-3.oel") @:noCompletion #if display private #end class __ASSET__assets_data_room_3_oel extends haxe.io.Bytes {}
@:keep @:file("assets/data/room-4.oel") @:noCompletion #if display private #end class __ASSET__assets_data_room_4_oel extends haxe.io.Bytes {}
...
@:keep @:file("assets/images/health.psd") @:noCompletion #if display private #end class __ASSET__assets_images_health_psd extends haxe.io.Bytes {}
...
@:keep @:file("assets/images/tiles.psd") @:noCompletion #if display private #end class __ASSET__assets_images_tiles_psd extends haxe.io.Bytes {}
